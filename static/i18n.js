...
(function () {
    ...
    const TRANSLATIONS = {
        te: {
            ...
            fileTooLargeError: 'ఫైల్ పరిమాణం 10MB కంటే ఎక్కువగా ఉంది. దయచేసి 10MB లోపు ఉన్న PDF లేదా ఇమేజ్ ఫైల్‌ను ఎంచుకోండి.',
            pdfOcrSupport: 'స్కాన్ చేసిన ఇమేజ్ పత్రాలు (OCR) & PDF లకు మద్దతు కలదు (గరిష్టం: 10 MB)',
            ...
            symptomFinderSummary: '🎯 మీ అవసరం / సమస్య ఆధారంగా పథకం కనుగొనండి',
            symptomChipHospital: '🏥 ఆసుపత్రిలో చేరడం / శస్త్రచికిత్స',
            symptomChipPregnancy: '🤰 గర్భం / ప్రసవం / బాలింత',
            symptomChipChildren: '👶 పిల్లల ఆరోగ్యం / టీకాలు',
            symptomChipElderly: '👴 వృద్ధాప్య చికిత్స / సంరక్షణ',
            symptomChipMedicines: '💊 ఉచిత మందులు / క్లినిక్',
            symptomChipEmergency: '🚑 అత్యవసర రవాణా (108/104)',
            symptomChipKidney: '🧬 డయాలసిస్ / దీర్ఘకాలిక వ్యాధి',
        ...
        en: {
            // App Shell & Header
            appTitle: 'SmartGov Health Portal',
            ...
            fileTooLargeError: 'File size exceeds 10MB limit. Please select a document under 10MB.',
            pdfOcrSupport: 'Supports scanned image documents (OCR) & PDFs (Max: 10 MB)',
            ...
            symptomChipPregnancy: '🤰 Pregnancy / Delivery / Care',
            symptomChipChildren: '👶 Child Health & Vaccines',
            symptomChipElderly: '👴 Elderly Care & Treatment',
            symptomChipMedicines: '💊 Free Medicines & Clinic',
            symptomChipEmergency: '🚑 Emergency Transport (108/104)',
            symptomChipKidney: '🧬 Dialysis & Chronic Illness',
